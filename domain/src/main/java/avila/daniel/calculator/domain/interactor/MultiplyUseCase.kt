...
class MultiplyUseCase(private val calc: ICalc) : SingleUseCaseWithParameter<Operands, Float> {
    override fun execute(parameter: Operands): Single<Float> = calc.multiply(parameter)
}